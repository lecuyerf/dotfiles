# Generated by Powerlevel10k configuration wizard on 2025-02-03 at 09:24 CET.
...
#99394 4138/7/11 - 0.26%
# Use the ratio to determine the color of the prompt.
# If the ratio is greater than 20% then use red, if less than 20% use orange.
# If the ratio is less than 10% then use green.
get_color_based_on_ratio() {
    local moab_info="$1"
    local ratio=$(echo "$moab_info" | awk -F'[-%]' '{print $2}')
...
function prompt_moab_java_info() {
    moab_info=$(moab_info.py java)
    color=$(get_color_based_on_ratio "$moab_info")
    p10k segment -i $'\u2615' -f "$color" -t "${moab_info}"
}
function prompt_moab_csharp_info() {
    moab_info=$(moab_info.py csharp)
    color=$(get_color_based_on_ratio "$moab_info")
    p10k segment -i 'C#' -f "$color" -t "${moab_info}"
}
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    time                    # current time
       # =========================[ Line #2 ]=========================
    newline
    #moab_java_info          # moab java info
    #moab_csharp_info        # moab csharp info
